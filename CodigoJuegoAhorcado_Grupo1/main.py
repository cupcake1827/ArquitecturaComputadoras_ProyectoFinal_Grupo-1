...
class RegistroJugador:
    def __init__(self, master, callback):
        ...
        pygame.init()
        pygame.mixer.init()
        self.sonido_registro = pygame.mixer.Sound("C:/Users/CRIS/Documents/Arquitectura de PC/ahorcado/sonidos/intro.wav")
        
        self.sonido_registro.play()
...
class JuegoAhorcado:
    def __init__(self, master, nombre_jugador):
        ...
        self.iniciar_juego()
        pygame.init()
        self.sonido_ganar=pygame.mixer.Sound("C:/Users/CRIS/Documents/Arquitectura de PC/ahorcado/sonidos/victoria.wav")
        self.sonido_perder=pygame.mixer.Sound("C:/Users/CRIS/Documents/Arquitectura de PC/ahorcado/sonidos/game over.wav")
